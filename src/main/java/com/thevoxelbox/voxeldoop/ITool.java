...
public interface ITool {
     ...
     *
     * @param targetBlock The target block that the player is looking at
     * @param face        The face of the block that the player is looking at
     * @param itemUsed    The item stack that is in the hand and being used at the time
     *                    of the event
     * @param player      The player using this tool
     * @param action      The corresponding bukkit action that called this tool use
     */
     ...
     *
     * @param targetBlock The target block that the player is looking at
     * @param face        The face of the block that the player is looking at, can be null
     * @param itemUsed    The item stack that is in the players hand and being used
